...
Currently, our tech stack is **TBD (To Be Determined)**. We are complete beginners in game development and are starting from absolute zero. 

We are currently exploring beginner-friendly engines and frameworks for 2D games, such as:
* **Godot** (GDScript) - Great for 2D and UI-heavy games.
* **Unity** (C#) - lots of tutorials.
* **Web Tech (React/Phaser)** - If we decide to make it a browser-based game.
*(We will update this section once we pick our primary engine!)*

## 🔄 Core Gameplay Loop (The Basic 4)

Our game is built on a satisfying loop of solving, earning, and unlocking.

* **➡️ ACTION:** You choose a new empty "house" (e.g., a Teapot) from templates and recieve a resident's letter with hints. You drag, drop, and layer furniture and decor stickers to meet the logical constraints (e.g., *lamp must be above the table*, *bed must be far from the door*).
...
* **Visuals:** 2D hand-drawn or pastel sticker art style.
